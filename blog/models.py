...
class Post(models.Model):
    ...
    medium_image = models.ImageField(_('Medium Image'), default='medium_blog_image.jpg', upload_to='profile_pics')
    small_image = models.ImageField(_('Small Image'), default='small_blog_image.jpg', upload_to='profile_pics')
